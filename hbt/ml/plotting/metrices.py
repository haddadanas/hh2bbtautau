...
def binary_roc_data(true_labels: np.ndarray,
    ...
    for t in thresholds:
        ...
        tp = cast_to_Number(sample_weights[np.logical_and(positives, trues)],
                            errors)
        tn = cast_to_Number(sample_weights[np.logical_and(positives == False,
                                                          trues == False)],
                            errors)
        fp = cast_to_Number(sample_weights[np.logical_and(positives,
                                                          trues == False)],
                            errors)
        fn = cast_to_Number(sample_weights[np.logical_and(positives == False,
                                                          trues)],
                            errors)
