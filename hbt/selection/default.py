...
@selector(
    uses={
        json_filter, met_filters, IF_RUN_3(jet_veto_map), trigger_selection, jet_selection,
...
def default(
    ...
    **kwargs,
    ...
    if self.use_loose_lepton_selection:
        ...
        events, lepton_results = self[lepton_tt_selection](events, trigger_results, **kwargs)
    else:
