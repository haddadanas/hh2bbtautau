...
@selector(
    uses={
        "Electron.{pt,eta,phi,dxy,dz,pfRelIso03_all,seediEtaOriX,seediPhiOriY,mvaIso,deltaEtaSC}",
...
def lepton_loose_selection(
    ...
    **kwargs,
    ...
    for trigger, trigger_fired, leg_masks in trigger_results.x.trigger_data:
        ...
        # tau selection
        tau_base_mask, tau_trigger_specific_mask, tau_iso_mask = self[loose_tau_selection](
            events,
            trigger,
            electron_mask,
            muon_mask,
...
def lepton_loose_selection_init(self: Selector, **kwargs) -> None:
