...
def add_config(
    ...
    cfg.x.keep_columns = DotDict.wrap({
        "cf.ReduceEvents": {
            ...
            "BJet.nJet", "BJet.E", "BJet.area", "BJet.nConstituents",
            "CollJet.btagDeepFlavB", "CollJet.hadronFlavour", "CollJet.pt", "CollJet.eta", "CollJet.phi",
            "CollJet.mass", "CollJet.E", "CollJet.nJet", "CollJet.nJet",
            "VBFJet.btagDeepFlavB", "VBFJet.hadronFlavour", "VBFJet.pt",
